...
from openpilot.selfdrive.controls.lib.nagaspilot.road_edge_detector import RoadEdgeDetector
...
def main(demo=False):
  ...
  # Use centralized parameter system for DesireHelper
  DH = DesireHelper(params=params)
  RED = RoadEdgeDetector(params.get_bool("np_lat_road_edge_detection"))
