...
from openpilot.selfdrive.nagaspilot.np_ssd import SimpleSSDTimer  # Stand Still Duration timer
from openpilot.selfdrive.nagaspilot.np_hod import SimpleHODTimer  # Hand Off Duration timer

# SOC Safety Controller - Phase 5 Implementation  
from openpilot.selfdrive.nagaspilot.np_soc_controller import SmartOffsetController  # Smart Offset Controller
...
class Controls:
  def __init__(self) -> None:
    ...
    self.soc_controller = SmartOffsetController()
