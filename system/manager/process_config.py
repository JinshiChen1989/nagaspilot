...
procs = [
  ...
  PythonProcess("eods_controller", "selfdrive.controls.eods_controller", eods_enabled),
  PythonProcess("soc_controller", "selfdrive.controls.soc_controller", soc_enabled),

  PythonProcess("sensord", "system.sensord.sensord", only_onroad, enabled=not PC),
  NativeProcess("ui", "selfdrive/ui", ["./ui"], always_run, watchdog_max_dt=(5 if not PC else None)),
  PythonProcess("soundd", "selfdrive.ui.soundd", only_onroad, enabled=not os.getenv("DISABLE_DRIVER")),
  PythonProcess("beepd", "openpilot.selfdrive.nagaspilot.ui.beepd", only_onroad, enabled=(Params().get_bool("np_device_beep") and os.getenv("DISABLE_DRIVER"))),
