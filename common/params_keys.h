...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LanguageSetting", {PERSISTENT, STRING, "main_th"}},
    ...
    {"dp_device_is_rhd", {PERSISTENT, BOOL, "1"}},
    ...
    {"dp_lat_lca_speed", {PERSISTENT, INT, "0"}},
    {"dp_lat_lca_auto_sec", {PERSISTENT, FLOAT, "2.0"}},
    {"np_lat_soc_speed", {PERSISTENT, INT, "0"}},
    {"np_lat_soc_adjacent_offset", {PERSISTENT, FLOAT, "2.8"}},
    {"np_lat_soc_edge_offset", {PERSISTENT, FLOAT, "1.6"}},
    {"np_lat_soc_lane_offset", {PERSISTENT, FLOAT, "1.2"}},
    {"np_lat_soc_return_rate", {PERSISTENT, FLOAT, "0.25"}},
    {"np_lat_soc_tta_sec", {PERSISTENT, FLOAT, "4.0"}},
    {"dp_device_go_off_road", {CLEAR_ON_MANAGER_START, BOOL}},
    {"dp_ui_hide_hud_speed_kph", {PERSISTENT, INT, "40"}},
    {"dp_lon_ext_radar", {PERSISTENT, BOOL, "0"}},
    {"dp_lat_road_edge_detection", {PERSISTENT, BOOL, "1"}},
    {"dp_ui_rainbow", {PERSISTENT, BOOL, "1"}},
    {"TotalDistance", {PERSISTENT, FLOAT, "0.0"}},
    {"TotalDrives", {PERSISTENT, INT, "0"}},
    ...
    {"np_trip_total_distance", {PERSISTENT, FLOAT, "0.0"}},
    {"np_trip_uptime_onroad", {PERSISTENT, FLOAT, "0.0"}},
    {"np_trip_total_drives", {PERSISTENT, INT, "0"}},
    {"np_trip_total_onroad_time", {PERSISTENT, FLOAT, "0.0"}},
    {"np_trip_current_uptime_onroad", {PERSISTENT, FLOAT, "0.0"}},
    {"np_trip_current_total_onroad_time", {PERSISTENT, FLOAT, "0.0"}},
    {"np_trip_current_engagement_ratio", {PERSISTENT, FLOAT, "0.0"}},
    {"np_trip_lifetime_engagement_ratio", {PERSISTENT, FLOAT, "0.0"}},
    {"np_trip_lifetime_interventions", {PERSISTENT, INT, "0"}},
    {"np_trip_current_interventions", {PERSISTENT, INT, "0"}},
};
